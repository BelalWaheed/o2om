...
class O2omDashboardView {
    static Build(g, appInstance, controlsList) {
        ; Status Text (y60 to clear separator line at y52)
        st := g.AddText("x20 y60 w345 h22 Center c" O2omStyles.COLOR_PRIMARY, "")
        ...
        ct := g.AddText("x20 y86 w345 h75 Center c" O2omStyles.COLOR_TEXT, "00:00")
        ct.SetFont("s44 Bold", O2omStyles.FONT_TITLE)
        appInstance.countdownText := ct
        controlsList.Push(ct)

        ; Action Buttons (Slot 1 at y168: Reset & Pause side-by-side, or StartWork)
        btnReset := g.AddButton("x43 y168 w145 h34", O2omLang.Get("btn_reset"))
        ...
        btnPause := g.AddButton("x198 y168 w145 h34", O2omLang.Get("btn_pause"))
        ...
        btnStartWork := g.AddButton("x43 y168 w300 h34", O2omLang.Get("btn_start_work"))
        ...
        btnStartBreak := g.AddButton("x43 y168 w300 h34", O2omLang.Get("btn_start_break"))
        ...
        btnStartExercises := g.AddButton("x43 y210 w300 h34", O2omLang.Get("btn_start_exercises"))
        ...
        btnSnooze := g.AddButton("x43 y252 w300 h34", O2omLang.Get("btn_snooze"))
        ...
        ; Auto-start Checkbox (At y300)
        isStartup := (appInstance.settings.startWithWindows == 1)
        chkStart := g.AddCheckbox("x43 y300 w300 h24 c" O2omStyles.COLOR_TEXT " " (isStartup ? "Checked" : ""), O2omLang.Get("chk_startup"))
